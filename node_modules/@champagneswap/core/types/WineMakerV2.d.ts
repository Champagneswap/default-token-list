...
interface WineMakerV2Interface extends ethers.utils.Interface {
  functions: {
    ...
    "harvestFromWineMaker()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "harvestFromWineMaker",
    values?: undefined
  ): string;
...
export class WineMakerV2 extends Contract {
  ...
  interface: WineMakerV2Interface;
  ...
  functions: {
    ...
    harvestFromWineMaker(overrides?: Overrides): Promise<ContractTransaction>;

    "harvestFromWineMaker()"(
      overrides?: Overrides
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    harvestFromWineMaker(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    harvestFromWineMaker(overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    harvestFromWineMaker(overrides?: Overrides): Promise<PopulatedTransaction>;
