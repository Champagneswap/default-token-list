...
interface GrapePairMediumRiskV1Interface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "cellar", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "cellar", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "claimOwnership",
    data: BytesLike
  ): Result;
...
export class GrapePairMediumRiskV1 extends Contract {
  ...
  interface: GrapePairMediumRiskV1Interface;
  ...
  functions: {
    ...
    cellar(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    cellar(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    cellar(overrides?: CallOverrides): Promise<PopulatedTransaction>;
