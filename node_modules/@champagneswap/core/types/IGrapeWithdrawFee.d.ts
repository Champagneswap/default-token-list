...
interface IGrapeWithdrawFeeInterface extends ethers.utils.Interface {
  functions: {
...
export class IGrapeWithdrawFee extends Contract {
  ...
  interface: IGrapeWithdrawFeeInterface;
