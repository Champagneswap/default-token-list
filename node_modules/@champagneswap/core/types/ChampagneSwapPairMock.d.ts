...
interface ChampagneSwapPairMockInterface extends ethers.utils.Interface {
  functions: {
...
export class ChampagneSwapPairMock extends Contract {
  ...
  interface: ChampagneSwapPairMockInterface;
