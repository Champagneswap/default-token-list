...
interface ChampagneSwapFactoryMockInterface extends ethers.utils.Interface {
  functions: {
...
export class ChampagneSwapFactoryMock extends Contract {
  ...
  interface: ChampagneSwapFactoryMockInterface;
