...
interface ChampagneMakerGrapeInterface extends ethers.utils.Interface {
  functions: {
...
export class ChampagneMakerGrape extends Contract {
  ...
  interface: ChampagneMakerGrapeInterface;
  ...
  callStatic: {
    ...
    convert(grapePair: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    convert(grapePair: string, overrides?: Overrides): Promise<BigNumber>;
