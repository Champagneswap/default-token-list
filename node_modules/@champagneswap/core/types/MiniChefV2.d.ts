...
interface MiniChefV2Interface extends ethers.utils.Interface {
  functions: {
    ...
    "chamPerSecond()": FunctionFragment;
    ...
    "setChamPerSecond(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "chamPerSecond",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setChamPerSecond",
    values: [BigNumberish]
  ): string;
  ...
  events: {
    ...
    "LogChamPerSecond(uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "LogChamPerSecond"): EventFragment;
...
export class MiniChefV2 extends Contract {
  ...
  functions: {
    ...
    chamPerSecond(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    ...
    LogChamPerSecond(chamPerSecond: null): EventFilter;
  ...
  populateTransaction: {
    ...
    chamPerSecond(overrides?: CallOverrides): Promise<PopulatedTransaction>;
